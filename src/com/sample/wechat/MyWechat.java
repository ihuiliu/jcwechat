...
import cn.goldfiance.base.MenuManger;
		...
		if(content.equals("1")){
			 ...
			 int len=0;
		        ...
		        try {
					...
					logger.error(this.getClass().getName()+"  UnsupportedEncodingException");
					e.printStackTrace();
				} catch (IOException e) {
					logger.error(this.getClass().getName()+"  IOException");
					e.printStackTrace();
				}
			 me.createMenu(menu);
